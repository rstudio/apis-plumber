...
Note: These steps are tested on Ubuntu Server 18.04 LTS. This is expected to work on most Linux systems such as Debian, Ubuntu, and others. Unfortunately, this option is not available for Windows. Windows users should refer to Docker or Digital Ocean sections.
...
Compared to `plumber::do_provision()` this option won't create a new droplet if you use Digital Ocean, it will run on your existing droplet instead.
