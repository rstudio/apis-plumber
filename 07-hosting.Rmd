...
```
If you find errors like SSL Error: CERT_UNTRUSTED while using npm command then to bypass https we use below commands:
```
npm config set strict-ssl false
```
or set the registry URL from https or http like below: use
```
